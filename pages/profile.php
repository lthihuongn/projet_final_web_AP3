...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'student') {
    header('Location: login.php?message=Accès+réservé+aux+profils+étudiants.&type=error');
    exit;
}
...
<body class="profil-page">
    <header class="topbar">
        ...
        <nav class="topnav" aria-label="Navigation principale">
            ...
            <a class="is-active" href="profile.php">Mon profil</a>
    ...
    <main class="profil-shell">
        ...
        <section class="profil-layout">
            ...
            <section class="profil-content">
                <form class="profil-form" id="profilForm" action="../api/save-cv.php" method="post">
                    ...
                    <div class="profil-actions">
                        ...
                        <a class="secondary-button profil-link" href="catalog.php">Voir le catalogue</a>
                    </div>
                </form>
            </section>
        </section>
